...
IMG_FILE="deploy/rk3576-photonicat2-debian-full.img"
...
BOOTFS_IMG_FILE="deploy/rk3576-photonicat2-debian-full-bootfs.img"
ROOTFS_IMG_FILE="deploy/rk3576-photonicat2-debian-full-rootfs.img"
