...
IMG_FILE="deploy/rk3576-photonicat2-ubuntu-minimal.img"
...
BOOTFS_IMG_FILE="deploy/rk3576-photonicat2-ubuntu-minimal-bootfs.img"
ROOTFS_IMG_FILE="deploy/rk3576-photonicat2-ubuntu-minimal-rootfs.img"
